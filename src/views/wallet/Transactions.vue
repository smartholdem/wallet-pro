      ...
      <card-body style="overflow-x: auto;">
        <table class="table table-hover" >
          ...
          <tr v-for="item in transactions.data" :key="item.id" :class="item.confirmations < 8 ? 'table-dark' : ''">
            ...
            <td>
              <i v-show="item.recipient === this.address" class="text-warning fas fa-sm fa-fw me-2 fa-angle-double-down"></i>
              <i v-show="item.recipient !== this.address" class="text-info fas fa-sm fa-fw me-2 fa-angle-double-up"></i>
              <span :class="item.recipient === this.address ? 'text-success' : ''">
